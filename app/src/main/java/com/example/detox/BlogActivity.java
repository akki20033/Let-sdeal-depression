                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                pd.dismiss();
                                                Toast.makeText(BlogActivity.this, "Post Published", Toast.LENGTH_SHORT).show();
                                                title_blog.setText("");
                                                description_blog.setText("");
                                                blog_image.setImageURI(null);
                                                image_uri = null;

                                                startActivity(new Intent(BlogActivity.this,bodActivity.class));
                                            }
                ...
                .withPermissions(
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport multiplePermissionsReport) {
                        if(multiplePermissionsReport.areAllPermissionsGranted()){
                            Toast.makeText(BlogActivity.this, "Permission granted", Toast.LENGTH_SHORT).show();
                        } else if (multiplePermissionsReport.areAllPermissionsGranted()) {
                            Toast.makeText(BlogActivity.this, "Please Grant Permission", Toast.LENGTH_SHORT).show();
                        }
                    }
